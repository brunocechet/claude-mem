...
export class SessionRoutes extends BaseRouteHandler {
  ...
  setupRoutes(app: express.Application): void {
    ...
    app.post(
      ...
      validateBody(SessionRoutes.observationsBatchByClaudeIdSchema),
      this.handleObservationsBatchByClaudeId.bind(this)
    );
    app.post(
  ...
  // Wave-3 client-side outbox drain endpoint. Accepts a session-grouped batch
  // of observations spooled while the worker was unreachable.
  private static readonly observationsBatchByClaudeIdSchema = z.object({
    contentSessionId: z.string().min(1),
    platformSource: z.string().optional(),
